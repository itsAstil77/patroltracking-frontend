...
export class WorkflowService {
  ...
  createWorkflow(data: any): Observable<any> {
    ...
    return this.http.post('http://172.16.100.68:5000/workflow/create', data, { headers });
  }
  ...
  getPatrolUsers(): Observable<any> {
    ...
    return this.http.get('http://172.16.100.68:5000/signup/non-admin', { headers });
  }
  ...
  updateWorkflow(workflowId: string, payload: any): Observable<any> {
    ...
    return this.http.put(`http://172.16.100.68:5000/workflow/update/${workflowId}`, payload, { headers });
  }
