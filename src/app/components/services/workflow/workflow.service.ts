...
export class WorkflowService {
  ...
  createWorkflow(data: any): Observable<any> {
    ...
    return this.http.post('http://172.16.100.31:5000/workflow/create', data, { headers });
  }

  private checklistUrl = 'http://172.16.100.31:5000/checklists';
  ...
  getPatrolUsers(): Observable<any> {
    ...
    return this.http.get('http://172.16.100.31:5000/signup/non-admin', { headers });
  }
  ...
  updateWorkflow(workflowId: string, payload: any): Observable<any> {
    ...
    return this.http.put(`http://172.16.100.31:5000/workflow/update/${workflowId}`, payload, { headers });
  }


  private checkbaseUrl = 'http://172.16.100.31:5000/checklists';
  ...
  getChecklistByWorkflowIds(workflowId: string): Observable<any> {
    ...
    const url = `http://172.16.100.31:5000/workflow/${workflowId}/checklists`;
    return this.http.get<any>(url, { headers });
  }
  
  
  private apiUrl = 'http://172.16.100.31:5000/locationcode';
  ...
  private assignUrl = 'http://172.16.100.31:5000/checklists/assign';
