...
export class PatrolCreationService {
  ...
  private apiUrl = 'http://172.16.100.31:5000/signup/users';
  ...
  return this.http.get<any>(`http://172.16.100.31:5000/signup/users?page=${page}&limit=${limit}`, { headers });
}
...
deleteUser(userId: string): Observable<any> {
    ...
    private roleUrl = 'http://172.16.100.31:5000/roles';
