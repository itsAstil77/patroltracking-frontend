...
export class PatrolCreationService {
  ...
  private apiUrl = 'http://172.19.9.152:5004/signup/users';
  ...
  return this.http.get<any>(`http://172.19.9.152:5004/signup/users?page=${page}&limit=${limit}`, { headers });
}
...
deleteUser(userId: string): Observable<any> {
    ...
    private roleUrl = 'http://172.19.9.152:5004/roles';
