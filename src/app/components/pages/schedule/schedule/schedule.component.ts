...
//   constructor(private workflowService: WorkflowService, private alertService: AlertService,private schedulingService:SchedulingService) { }
...
// // description = '';
// type = '';
// createdBy = '';  // you can dynamically set from logged-in user
// selectedDates: Date[] = [];

// selectDate(event: any) {
//   const date = event.value;
//   if (date && !this.selectedDates.some(d => d.getTime() === date.getTime())) {
...
//     description: this.description,
//     type: this.type,
//     scheduledDates: this.selectedDates.map(d =>
//       new Date(d).toISOString().split('T')[0] // convert to YYYY-MM-DD
//     ),
//     createdBy: this.createdBy
//   };
...
// //   selectDate(event: any) {
// //     const date = event.value;
// //     const exists = this.selectedDates.find(d => d.getTime() === date.getTime());
// //     if (!exists) {
// //       this.selectedDates.push(date);
// //     }
// //   }
